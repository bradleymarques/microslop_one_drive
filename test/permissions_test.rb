...
module MicroslopOneDrive
  class PermissionsTest < BaseTest
    ...
    def test_permissions_fetches_the_permissions_for_a_drive_item_with_an_anonymous_link
      ...
      assert_permission(permissions[3], item_id, "Example Person", "person@example.com", "person@example.com", "owner", "user")
    end
    ...
    def test_permissions_removed
      ...
      assert_permission(permissions[0], item_id, "Example Person", "person@example.com", "person@example.com", "owner", "user")
    end
  end
end
